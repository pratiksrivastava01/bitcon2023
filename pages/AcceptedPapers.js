            ...
            <div className="p-4 flex flex-col gap-2 flex-wrap items-center">
              <table className="">
                <thead className="bg-[#002E73] ">
                  <tr>
                    <th className="p-4 text-white text-center">Sr. No.</th>
                    <th className="p-4 text-white text-center">Paper ID</th>
                  </tr>
                </thead>
                <tbody className="text-sm sm:text-xs">
                  {papers.map((paper, index) => (
                    <tr key={paper.index}>
                      <td className="p-4">{paper.s_no}</td>
                      <td className="p-4">{paper.p_id}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
