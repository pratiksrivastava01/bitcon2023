      ...
      <div className="flex flex-row items-center sm:flex-col">
        <div className="h-[93.8rem] w-[25rem] border-2  border-primary mt-[5rem] ml-[8rem] shadow-2xl sm:ml-[0.2rem] sm:h-auto sm:w-[21rem]">
          <div className="p-5">
            ...
            <p>
              Dr Pankaj Rai <br /> Dept. of EE, BIT Sindri <br /> Dr. D. K.
              Tanti <br /> Dept. of EE, BIT Sindri
            </p>
            <h2 className="mt-[2rem] font-bold text-lg sm:text-sm">
            ...
            <p>
              Dr. Nirmala Soren <br /> Dept. of EE, BIT Sindri <br /> Dr.
              Rajendra Murmu <br /> Dept. of EE, BIT Sindri
            </p>
            <h2 className="mt-[2rem] font-bold text-lg sm:text-sm">
              Coordinators
            </h2>
            ...
            <p>
              ...
              <span className="font-bold text-lg"> 15 August, 2023 </span>{" "}
              <br /> Paper Acceptance notification: <br />
              <span className="font-bold text-lg"> 30 October, 2023</span>{" "}
              <br /> Camera ready version: <br />
              <span className="font-bold text-lg">01 November, 2023</span>{" "}
              <br /> Registration Commences: <br />
              <span className="font-bold text-lg">15 November, 2023</span>{" "}
              <br />
              Registration Closes: <br />
              <span className="font-bold text-lg">30 November, 2023</span>{" "}
              <br /> Conference Date: <br />
        ...
        <div className="h-auto w-[53rem] border-2  border-primary shadow-2xl mt-[5rem] sm:ml-[0.2rem] ml-[2rem] sm:h-auto sm:w-[21rem]">
          <p className="p-5 mt-[2rem] ml-[1rem] mr-[1rem] sm:text-xs text-center">
            ...
            peer-reviewed oral and poster presentations. BITCON-2023
            <br />
            <span className="text-xl text-[#002E73] sm:text-sm font-bold">
              Theme:
            </span>
            ...
            <p className="mt-[2rem]">
              ...
              There will be three major tracks namely (i) Electrical
              Engineering, (ii) Mechatronics & Robotics and (iii) Green
              Engineering Technology. Each track has the following main
              components; a) Paper presentations and best paper awards for each
              track, b) Poster presentations and best poster awards for each
              track, c) Key Note Lectures, d) Panel discussions, e) Awards for
              best M.Tech Dissertation, and f) Awards for best PhD Thesis.
            </p>
          </p>
          ...
          <div className="mt-[2rem]">
            ...
            <p className="p-4 sm:text-xs">
              ...
              publication during the entire review process. All submissions must
              be in English only and in PDF format.
            </p>{" "}
            <p className="p-4 sm:text-xs">
              <span className="text-[#002E73] font-bold text-xl ml-8  sm:text-sm">
              ...
              degrees must be awarded between 1st November 2022 to 31st November
              2023 from any Indian Institute/University. The submitted theses
              ...
              PhD thesis award for year 2022.
            </p>
          </div>
          <p className="p-4 sm:text-xs">
            <span className="text-[#002E73] font-bold text-xl ml-8  sm:text-sm">
